GameCube Rebuilder версия 1.0 by BSV (bsv798@gmail.com)
Дата компиляции: July 2009.
---------------------------------------------------------

Утилита GameCube Rebuilder (GCR далее) предназначена для работы с образами
платформы Nintendo GameCube. GCR написана на языке Visual C# v3.0 и для своей
работы требует .Net Framework версии не ниже 3.5, которую можно скачать по этой ссылке:
